# AGENTS.md — MTG Terminal Builder
...
- (Planned) Get AI-powered deck suggestions using the Codex API
...
- Do not add external API calls (Scryfall API, Codex API) without discussing it first
...
- Codex API integration for deck suggestions and card explainer
